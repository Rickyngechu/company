...
const btnScrollTo = document.querySelector("#about");

const topBtn = document.querySelector(".btn-scroll");
const header = document.querySelector("#head");
const head = document.querySelector(".header");
const sections = document.querySelectorAll(".section");

// const naviCont = document.querySelector(".navigation__list");
/////////////////////////////////////////////////
///Implementing the smooth scrolling effect
aboutBtn.addEventListener("click", function (e) {
  e.preventDefault();
  const s1coords = btnScrollTo.getBoundingClientRect();
  window.scrollTo({
...
topBtn.addEventListener("click", function (e) {
  ...
  const sectionHead = header.getBoundingClientRect();
  window.scrollTo({
    left: sectionHead.left,
    top: sectionHead.top,
    behavior: "smooth",
  });
...
// //The smooth scroll on navigation link
...
//////////////////////////////////////////
//IMPLEMENTATION OF SMOOTH SCROLLING USING EVENT DELEGATION
document
...
/////////////////////////////////////////
//ADDING THE IS ACTIVE CLASS TO THE LINK
document
  .querySelector(".navigation__list")
  .addEventListener("click", function (e) {
    e.preventDefault();
...
////////////////////////////////////////
//IMPLEMENTING THE STRICKY NAV

// const sectionCord = section1.getBoundingClientRect();
// console.log(sectionCord);
...
const objObserver = new IntersectionObserver(callBack, {
  root: null,
  threshold: 0,
  rootMargin: `-${topHeight}px`,
});

objObserver.observe(header);
...
const observeSect = new IntersectionObserver(callsect, {
  root: null,
  threshold: 0.15,
});
